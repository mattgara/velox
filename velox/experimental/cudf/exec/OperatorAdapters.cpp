...
void registerAllOperatorAdapters() {
  ...
  // Register the UCX manager and its matching output operator as one transport
  // entry. Current main resolves this entry from PartitionedOutputNode.
        ...
        exec::OutputTransportEntry::make<
            ...
            [](int32_t operatorId,
              ...
              return std::make_unique<
                  ...
                  operatorId, ctx, node, boundManager);
            });
