...
/// values are mapped to exact integers, FOR encoded, and bit-packed in
/// warp-sized bit planes. Values that cannot be reconstructed bit-for-bit are
/// stored as exceptions and patched by one GPU thread per exception.
