...
.. list-table::
   ...
   * - cudf.memory_resource
     - string
     - async
     - The memory resource to use for cuDF. Possible values are (cuda, pool, async, async_preallocated, arena, managed, managed_pool, prefetch_managed, prefetch_managed_pool).
   ...
   * - cudf.memory_percent
     - integer
     - 50
     - The initial percent of GPU memory to allocate for pool, arena, or async_preallocated memory resources.
